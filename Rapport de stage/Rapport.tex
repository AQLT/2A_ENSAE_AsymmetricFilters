...
An \faIcon{r-project} interface is implemented in the package \texttt{rjdfilters}\footnote{\url{https://github.com/palatej/rjdfilters}.} was developed during this internship.
