...
In this case, the quantity $2h+1$ is called the *bandwith*.
...
- the number of neighbored, *bandwith* $H=2h+1$.
...
<!-- So: -->
<!-- $$ -->
<!-- \kappa_j^{E}\geq \kappa_j^{BW} \geq \kappa_j^{TW},\quad -->
<!-- \kappa_j^{E}\geq \kappa_j^T,\quad -->
