...
covid_tp_fixedylin_mul <- formatage_db("comparison_filters/turning_points/full_turning_points_du_fixedylin.RDS",
                                   date_deb = 2020, date_fin = 2021, trend_length = 13,
                                   decomposition = "Multiplicative")
covid_tp_fixedylin_add <- formatage_db("comparison_filters/turning_points/full_turning_points_du_fixedylin.RDS",
                                       date_deb = 2020, date_fin = 2021, trend_length = 13,
...
fc_tp_fixedylin_mul <- formatage_db("comparison_filters/turning_points/full_turning_points_du_fixedylin.RDS",
                                date_deb = 2007, date_fin = 2009, trend_length = 13,
                                decomposition = "Multiplicative")
fc_tp_fixedylin_add <- formatage_db("comparison_filters/turning_points/full_turning_points_du_fixedylin.RDS",
                                date_deb = 2007, date_fin = 2009, trend_length = 13,
                                decomposition = "Additive")
...
cbind(table_jsm(covid_tp_fixedylin_add),
      table_jsm(covid_tp_fixedylin_mul))

cbind(table_jsm(fc_tp_fixedylin_mul),
table_jsm(fc_tp_fixedylin_add))


saveRDS(unique(do.call(rbind, covid_tp_fixedylin)$series),
        file = "JSM/covid_series.RDS")
table_covid <- table_jsm(covid_tp_fixedylin) # 899
table_covid_diff <- table_jsm(covid_tp_fixedylin, diff = TRUE)
table_fc <- table_jsm(fc_tp_fixedylin) #2466

table_covid_23 <- table_jsm(covid_tp_fixedylin_23) # 55
table_fc_23 <- table_jsm(fc_tp_fixedylin_23) # 461
