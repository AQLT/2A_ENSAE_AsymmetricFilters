...
1. Mieux d'utiliser un filtre asymétrique optimisé qu'un filtre symétrique plus court ?  
\faArrowCircleRight{} a priori pas très différent, si on prend un filtre asymétrique en minimisant la phase, on devrait trouver des coefficients proches d'un filtre symétrique court. Doit pouvoir se vérifier facilement.
